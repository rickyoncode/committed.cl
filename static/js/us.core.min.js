...
if($this.hasClass('facebook')){window.open("http://web.archive.org/web/20240507184448/http://www.facebook.com/sharer/sharer.php?u="+encodeURIComponent(opt.url)+"&t="+encodeURIComponent(opt.text)+"","","toolbar=0, status=0, width=900, height=500")}else if($this.hasClass('twitter')){window.open("http://web.archive.org/web/20240507184448/https://twitter.com/intent/tweet?text="+encodeURIComponent(opt.text)+"&url="+encodeURIComponent(opt.url),"","toolbar=0, status=0, width=650, height=360")}else if($this.hasClass('linkedin')){window.open('http://web.archive.org/web/20240507184448/https://www.linkedin.com/shareArticle?mini=true&url='+encodeURIComponent(opt.url),'linkedin','toolbar=no,width=550,height=550')}else if($this.hasClass('gplus')){window.open("http://web.archive.org/web/20240507184448/https://plus.google.com/share?hl="+encodeURIComponent(opt.lang)+"&url="+encodeURIComponent(opt.url),"","toolbar=0, status=0, width=900, height=500")}else if($this.hasClass('pinterest')){window.open('http://web.archive.org/web/20240507184448/http://pinterest.com/pin/create/button/?url='+encodeURIComponent(opt.url)+'&media='+encodeURIComponent(opt.image)+'&description='+encodeURIComponent(opt.text),'pinterest','toolbar=no,width=700,height=300')}else if($this.hasClass('vk')){window.open('http://web.archive.org/web/20240507184448/http://vk.com/share.php?url='+encodeURIComponent(opt.url)+'&title='+encodeURIComponent(opt.text),'&description=&image='+encodeURIComponent(opt.image),'toolbar=no,width=700,height=300')}else if($this.hasClass('email')){window.location='mailto:?subject='+opt.text+'&body='+opt.url}})}(jQuery);!function($){"use strict";if($('.l-preloader').length){$('document').ready(function(){setTimeout(function(){$('.l-preloader').addClass('done')},500);setTimeout(function(){$('.l-preloader').addClass('hidden')},1000)})}}(jQuery);jQuery(function($){$('.w-tabs .rev_slider').each(function(){var $slider=$(this);$slider.bind("revolution.slide.onloaded",function(e){$us.canvas.$container.on('contentChange',function(){$slider.revredraw()})})})})

}
/*
     FILE ARCHIVED ON 18:44:48 May 07, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:13:45 Nov 05, 2025.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 27.45
  LoadShardBlock: 116.929 (3)
  PetaboxLoader3.datanode: 141.208 (5)
  load_resource: 182.637
  PetaboxLoader3.resolve: 59.144
  loaddict: 104.025
*/